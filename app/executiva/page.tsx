...
// ========== DADOS DA LANDING PAGE — AVIAÇÃO EXECUTIVA (OTIMIZADA PARA CONVERSÃO) ==========
...
const benefits = [
  {
    icon: Plane,
    title: 'Processo técnico com especialista real',
    description: 'Nada de despachante genérico. Ricardo Dantas, credenciado ANAC e homologado DECEA, conduz pessoalmente seu projeto de ponta a ponta.'
  },
  {
    icon: ClipboardCheck,
    title: 'Conformidade com RBAC, ICA 63-4 e PAPI',
    description: 'Domínio total das normas técnicas. Seu aeródromo ou heliponto atende a todos os requisitos normativos sem retrabalho.'
  },
  {
    icon: Shield,
    title: 'Aprovação na primeira submissão',
    description: '+90 projetos com 100% de aprovação na primeira tentativa. Zero surpresas, zero atrasos desnecessários.'
  }
]

const faqs = [
  {
    question: 'Vocês trabalham com balizamento noturno e PAPI?',
    answer: 'Sim. Temos expertise completa em projeto e homologação de sistemas de balizamento noturno e indicadores de percurso de aproximação de precisão (PAPI), em conformidade com a ICA 63-4 e requisitos DECEA.'
  },
  {
    question: 'Qual o diferencial para quem já entende do setor?',
    answer: 'Você sabe que a diferença entre aprovação rápida e meses de atraso está nos detalhes técnicos do projeto executivo e na relação com os órgãos. Nós entregamos a documentação exatamente como ANAC e DECEA exigem, na primeira tentativa.'
  },
  {
    question: 'Atendem hangar de táxi aéreo com múltiplas aeronaves?',
    answer: 'Sim. Regularizamos toda a infraestrutura de solo, incluindo pátios, pistas e helipontos, para operadores de táxi aéreo. O diagnóstico gratuito já mapeia todas as exigências aplicáveis à sua operação.'
  },
  {
    question: 'Quanto tempo para homologar um heliponto privado?',
    answer: 'O prazo médio é de 120 dias, variando conforme a complexidade. Após o diagnóstico gratuito, você recebe um cronograma detalhado.'
  }
]

export default function AvExecutivaLandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const leadData = {
        ...
        source: 'Landing Page - Aviação Executiva'
      }
      ...
      if (response.success) {
        ...
        const urgencySelect = document.getElementById('project-urgency-av') as HTMLSelectElement
  ...
  return (
    <main className="min-h-screen bg-white">
      <title>Homologação para Aviação Executiva | RAD Consultoria Aeronáutica</title>
      <meta name="description" content="Homologação técnica de aeródromos e helipontos para aviação executiva. Especialista RBAC, PAPI, ICA 63-4. Diagnóstico gratuito em 24h." />
          ...
          <div className="flex flex-col gap-16 lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-700 to-blue-800 text-white px-4 py-2.5 rounded-full text-xs sm:text-sm font-semibold mb-6 sm:mb-8 shadow-lg border border-blue-700">
                ...
                <span>90+ Projetos com 100% de Aprovação</span>
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
                Homologação técnica{' '}
                <span className="text-blue-800 block sm:inline">feita por quem entende do setor</span>
              </h1>

              <p className="mt-6 text-lg sm:text-xl text-gray-700 leading-relaxed">
                Nada de amadores. Ricardo Dantas conduz pessoalmente cada projeto RBAC, PAPI, ICA 63-4.
            ...
            >
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl shadow-blue-500/20 border border-gray-200 bg-white">
                <img
                  src="/gallery/jato-executivo.jpg"
                  alt="Jato executivo em hangar homologado pela RAD Consultoria Aeronáutica"
                  className="w-full h-64 sm:h-80 md:h-96 object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 sm:p-6">
                  <p className="text-white font-semibold text-sm sm:text-base">Hangar Executivo JetSouth · Homologado</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-3">
                Credenciado ANAC, homologado DECEA, especialista RBAC. 15+ anos de atuação focada em aviação executiva e táxi aéreo.
              </p>
      ...
      {/* NOVA SEÇÃO: Atraso na homologação custa horas de voo paradas */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-5 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Atraso na homologação custa <span className="text-red-700">horas de voo paradas</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Você não pode esperar meses por um despachante que erra documentação. Nós entregamos certo na primeira submissão.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">O risco do amadorismo</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700">Documentação técnica incorreta, rejeitada na primeira análise da ANAC</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-red-700 font-bold text-xs">!</span>
                  </div>
                  <p className="text-gray-700">Meses de vai-e-vem até o certificado, com o hangar ou aeronave parados</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-red-700 font-bold text-xs">!</span>
                  </div>
                  <p className="text-gray-700">Falhas em PAPI e balizamento que não atendem à ICA 63-4</p>
                </li>
              </ul>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Excelência técnica comprovada</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700"><strong>Homologação rápida</strong> com quem tem 100% de aprovação</p>
                </li>
              </ul>
              <div className="mt-6 p-4 bg-green-50 rounded-xl border border-green-100 flex items-start gap-3">
                ...
                <p className="text-sm text-green-800">
                  Diagnóstico <strong>sem custo</strong>. Converse diretamente com Ricardo Dantas.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section id="case" className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-5 lg:px-8">
          ...
          >
            <img
              src="/gallery/jato-executivo.jpg"
              alt="Hangar executivo homologado pela RAD Consultoria Aeronáutica"
            ...
            <div className="p-6 sm:p-10 flex flex-col justify-center">
              <span className="inline-block bg-blue-100 text-blue-800 px-2.5 py-1 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4 w-fit">
                Case Aviação Executiva
              </span>
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">Hangar Executivo JetSouth</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
                Operador de táxi aéreo com 3 aeronaves. Regularizamos pista, pátio e PAPI em tempo recorde, sem nenhum apontamento da ANAC.
              </p>
              <blockquote className="border-l-4 border-blue-700 pl-4 py-2 mb-4 bg-blue-50/50 rounded-r-lg">
                <p className="text-sm sm:text-base text-gray-700 italic leading-relaxed">
                  “Finalmente encontramos um especialista que fala a nossa língua. Zero retrabalho.”
                </p>
                <footer className="text-xs sm:text-sm text-gray-500 mt-1">— Diretor de Operações, JetSouth</footer>
              </blockquote>
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <MapPin className="w-4 h-4 text-blue-700" />
                <span>Aprovado sem ressalvas</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-5 lg:px-8">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
              <div className="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-4 md:gap-6">
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    <label htmlFor="project-type-av" className="block text-sm font-semibold text-gray-900 mb-2">
                      Tipo de Projeto *
                    </label>
                    <select
                      id="project-type-av"
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full text-gray-900 px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-lg sm:rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm sm:text-base"
                      placeholder="piloto@operadora.com"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full text-gray-900 px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-lg sm:rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm sm:text-base"
                      placeholder="Aeródromo / Cidade - Estado"
                    />
                  </div>

                  <div>
                    <label htmlFor="project-urgency-av" className="block text-sm font-semibold text-gray-900 mb-2">
                      Urgência do Projeto
                    </label>
                    <select
                      id="project-urgency-av"
                      name="urgency"
                      className="w-full text-gray-900 px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-lg sm:rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all bg-white text-sm sm:text-base"
                    >
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              <p className="text-sm text-gray-600 mb-4">Prefere falar direto com Ricardo Dantas?</p>
              <motion.a
                href="https://wa.me/5586999811672?text=Olá!%20Homologação%20aviação%20executiva."
                onClick={() => AnalyticsEvents.whatsappClick('lp_avexecutiva_form')}
                target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 text-base leading-relaxed max-w-md">
                Homologação técnica para aviação executiva.
              </p>
            </div>
            <div>
      ...
      <motion.a
        href="https://wa.me/5586999811672?text=Olá!%20Homologação%20aviação%20executiva."
        onClick={() => AnalyticsEvents.whatsappClick('lp_avexecutiva_float')}
        target="_blank"
        rel="noopener noreferrer"
