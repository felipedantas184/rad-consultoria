...
// ========== DADOS DA LANDING PAGE — SETOR PÚBLICO (OTIMIZADA PARA CONVERSÃO) ==========
...
const benefits = [
  {
    icon: Landmark,
    title: 'Desenvolvimento regional acelerado',
    description: 'Um aeródromo homologado atrai investimentos privados, turismo de negócios e melhora a infraestrutura logística do município.'
  },
  {
    icon: Plane,
    title: 'Captação de recursos e parcerias',
    description: 'A documentação regular permite convênios com governos estaduais e federais, além de acesso a linhas de financiamento para obras de ampliação.'
  },
  {
    icon: Building2,
    title: 'Segurança institucional',
    description: 'Blindagem jurídica para o gestor público, que demonstra zelo pela legalidade e entrega um equipamento público em total conformidade com a legislação aeronáutica.'
  }
]

const faqs = [
  {
    question: 'Nossa prefeitura tem orçamento limitado. Como viabilizar o projeto?',
    answer: 'Oferecemos um diagnóstico gratuito inicial que identifica a situação atual e as etapas necessárias. A partir daí, é possível planejar a execução em fases, adequando-se ao fluxo orçamentário do município. Muitos projetos começam com o levantamento técnico, que é o investimento mais leve.'
  },
  {
    question: 'Qual o prazo para um aeroporto municipal ficar regularizado?',
    answer: 'Em média 120 a 180 dias, dependendo da complexidade. O diagnóstico gratuito em 24h já apresenta um cronograma detalhado para sua administração.'
  },
  {
    question: 'A regularização aumenta a chance de receber voos comerciais?',
    answer: 'Sim. Companhias aéreas e operadores de táxi aéreo só operam em aeródromos homologados. A regularização é pré-requisito para atração de voos regulares e fretamentos.'
  },
  {
    question: 'Quais documentos a prefeitura precisa fornecer?',
    answer: 'Principalmente documentação fundiária e projetos arquitetônicos. Nossa equipe orienta passo a passo a equipe municipal, reduzindo o retrabalho e as idas e vindas com os órgãos reguladores.'
  }
]

export default function SetorPublicoLandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const leadData = {
        ...
        source: 'Landing Page - Setor Público'
      }
      ...
      if (response.success) {
        ...
        const urgencySelect = document.getElementById('project-urgency-pub') as HTMLSelectElement
  ...
  return (
    <main className="min-h-screen bg-white">
      <title>Regularização de Aeroporto Municipal | RAD Consultoria Aeronáutica</title>
      <meta name="description" content="Regularize o aeródromo do seu município com 100% de aprovação. Atração de investimentos e segurança institucional. Diagnóstico gratuito em 24h." />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-emerald-700 to-emerald-800 text-white px-4 sm:px-5 py-2.5 rounded-lg hover:shadow-md transition-all font-medium text-xs sm:text-sm flex items-center gap-2 cursor-pointer shadow-sm border border-emerald-600"
            >
              <Calendar size={14} />
      ...
      {/* Hero */}
      <section className="pt-24 pb-8 md:pt-40 md:pb-28 bg-gradient-to-br from-emerald-50 via-white to-gray-50 relative overflow-hidden">
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-emerald-500/5 rounded-full blur-3xl md:top-10 md:right-10 md:w-72 md:h-72"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8 relative z-10">
          <div className="flex flex-col gap-16 lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-700 to-emerald-800 text-white px-4 py-2.5 rounded-full text-xs sm:text-sm font-semibold mb-6 sm:mb-8 shadow-lg border border-emerald-700">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
                Transforme o aeródromo do município em{' '}
                <span className="text-emerald-700 block sm:inline">motor de desenvolvimento</span>
              </h1>

              <p className="mt-6 text-lg sm:text-xl text-gray-700 leading-relaxed">
                Regularize sua infraestrutura aeronáutica e atraia investimentos, turismo e conectividade.
              ...
              <div className="mt-10 sm:mt-12">
                <motion.a
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center justify-center w-full sm:w-auto bg-gradient-to-r from-emerald-700 to-emerald-900 text-white px-6 py-4 rounded-xl sm:rounded-2xl hover:shadow-xl transition-all shadow-lg hover:shadow-emerald-900/30 font-bold text-base sm:text-lg gap-3 sm:gap-4 cursor-pointer group"
                >
            ...
            >
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl shadow-emerald-500/20 border border-gray-200 bg-white">
                <img
                  src="/gallery/aeroporto-municipal.jpg"
                  alt="Aeroporto municipal homologado pela RAD Consultoria Aeronáutica"
                  className="w-full h-64 sm:h-80 md:h-96 object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 sm:p-6">
                  <p className="text-white font-semibold text-sm sm:text-base">Aeroporto Municipal de Esperança · Em Homologação</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
            {trustSignals.map((signal) => (
              ...
              >
                <signal.icon className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-700 mx-auto mb-2 sm:mb-3" />
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-3">
                Credenciado ANAC, homologado DECEA — especialista em projetos de infraestrutura aeroportuária pública.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="inline-flex items-center gap-1.5 bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
      ...
      {/* NOVA SEÇÃO: Adiar a regularização custa oportunidades */}
      <section id="urgencia" className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-red-50/30 via-white to-emerald-50/30">
        <div className="max-w-5xl mx-auto px-4 sm:px-5 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Adiar a regularização custa <span className="text-red-700">oportunidades</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Recursos federais, voos comerciais e investimentos privados só chegam com a documentação em dia.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Riscos de postergar</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700">Perda de linhas de financiamento federal para infraestrutura</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-red-700 font-bold text-xs">!</span>
                  </div>
                  <p className="text-gray-700">Impossibilidade de receber voos fretados e turismo de negócios</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-red-700 font-bold text-xs">!</span>
                  </div>
                  <p className="text-gray-700">Desgaste político com cobranças da população por melhorias</p>
                </li>
              </ul>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Caminho descomplicado</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700"><strong>Receba análise técnica</strong> em 24h</p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-green-700 font-bold text-xs">3</span>
                  </div>
                  <p className="text-gray-700"><strong>Planeje a execução</strong> conforme o orçamento público</p>
                </li>
              </ul>
              <div className="mt-6 p-4 bg-green-50 rounded-xl border border-green-100 flex items-start gap-3">
                ...
                <p className="text-sm text-green-800">
                  Diagnóstico <strong>sem custo</strong> e sem compromisso de contratação imediata.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      {/* Benefícios */}
      <section id="beneficios" className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-emerald-50 via-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">
              Infraestrutura que gera legado
            </h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r from-emerald-700 to-emerald-800 rounded-xl flex items-center justify-center mb-4 sm:mb-6">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-5 lg:px-8">
          ...
          >
            ...
            <div className="p-6 sm:p-10 flex flex-col justify-center">
              <span className="inline-block bg-emerald-100 text-emerald-800 px-2.5 py-1 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4 w-fit">
                Case Prefeitura
              </span>
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">Aeroporto Municipal de Esperança</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
                Município com aeródromo desativado há anos. A RAD conduziu o processo de regularização e hoje o aeroporto opera voos de táxi aéreo e atrai empresas de logística.
              </p>
              <blockquote className="border-l-4 border-emerald-700 pl-4 py-2 mb-4 bg-emerald-50/50 rounded-r-lg">
                <p className="text-sm sm:text-base text-gray-700 italic leading-relaxed">
                  “A regularização trouxe visibilidade para nossa cidade e abriu portas para investimentos que antes não existiam.”
                </p>
                <footer className="text-xs sm:text-sm text-gray-500 mt-1">— Secretário de Desenvolvimento Econômico</footer>
              </blockquote>
      ...
      {/* Formulário */}
      <section id="contato" className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-emerald-50 via-white to-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-5 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">
              Seu município pronto para decolar?
            </h2>
          ...
          >
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-6 sm:mb-8 pb-6 sm:pb-8 border-b border-gray-100">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r from-emerald-700 to-emerald-800 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
              <div className="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-4 md:gap-6">
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-gray-900 px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-lg sm:rounded-xl border border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all text-sm sm:text-base"
                  ...
                  <div>
                    <label htmlFor="project-type-pub" className="block text-sm font-semibold text-gray-900 mb-2">
                      Tipo de Projeto *
                    </label>
                    <select
                      id="project-type-pub"
                      ...
                      onChange={handleInputChange}
                      className="w-full text-gray-900 px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-lg sm:rounded-xl border border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all bg-white text-sm sm:text-base"
                    >
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    <label htmlFor="project-urgency-pub" className="block text-sm font-semibold text-gray-900 mb-2">
                      Urgência do Projeto
                    </label>
                    <select
                      id="project-urgency-pub"
                      name="urgency"
                      className="w-full text-gray-900 px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-lg sm:rounded-xl border border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all bg-white text-sm sm:text-base"
                    >
              ...
              <div className="bg-blue-50/50 rounded-lg sm:rounded-xl p-4 sm:p-5 border border-blue-100">
                <div className="flex items-start gap-3">
                  <div className="flex items-center h-5 sm:h-6 mt-0.5">
                    <input
                      id="privacy-policy-pub"
                      type="checkbox"
                      required
                      className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500 cursor-pointer"
                    />
                  </div>
                  <label htmlFor="privacy-policy-pub" className="text-sm text-gray-700 cursor-pointer">
              ...
              <div className="pt-2 sm:pt-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full bg-gradient-to-r from-emerald-700 to-emerald-800 text-white py-3.5 sm:py-4 rounded-lg sm:rounded-xl hover:shadow-lg sm:hover:shadow-xl transition-all font-bold text-base sm:text-lg shadow-md"
                >
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              ...
              <motion.a
                href="https://wa.me/5586999811672?text=Olá!%20Regularização%20de%20aeródromo%20municipal."
                onClick={() => AnalyticsEvents.whatsappClick('lp_setorpublico_form')}
                target="_blank"
      ...
      <section id="faq" className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-5 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">
              Perguntas de gestores públicos
            </h2>
          </motion.div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-emerald-700 flex-shrink-0 transition-transform ${openFaq === index ? 'rotate-180' : ''}`}
                  />
                </button>
                <AnimatePresence>
                  {openFaq === index && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 text-base leading-relaxed max-w-md">
                Regularização aeronáutica para o setor público.
              </p>
            </div>
            <div>
      ...
      <motion.a
        href="https://wa.me/5586999811672?text=Olá!%20Regularização%20de%20aeródromo%20municipal."
        onClick={() => AnalyticsEvents.whatsappClick('lp_setorpublico_float')}
        target="_blank"
        rel="noopener noreferrer"
